...
describe("Contract", function(){
    ...
    it("Make the first posibilty to win", async function() {
        await this.contract.connect(jucator1).mutare(1);
        await this.contract.connect(jucator2).mutare(4);
        await this.contract.connect(jucator1).mutare(2);
        await this.contract.connect(jucator2).mutare(5);
        await this.contract.connect(jucator1).mutare(3);
        //first row 
    });
