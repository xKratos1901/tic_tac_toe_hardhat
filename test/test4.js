...
describe("Contract", function(){
    ...
    it("Make the fifth posibilty to win", async function() {
        await this.contract.connect(jucator1).mutare(5);
        await this.contract.connect(jucator2).mutare(9);
        await this.contract.connect(jucator1).mutare(7);
        await this.contract.connect(jucator2).mutare(3);
        await this.contract.connect(jucator1).mutare(2);
        await this.contract.connect(jucator2).mutare(6);
        //right column
    });
